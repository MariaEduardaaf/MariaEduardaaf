...
* **Architecture:** Monorepos (Turborepo), REST APIs, multi-tenant SaaS, containerised services.
* **Tooling:** TypeScript strict, Zod, ESLint, Prettier, Git, CI/CD.

---

### 🚀 Current Focus
- 📱 Cross-platform apps with **Expo Router** and **Convex** for real-time data.
- 🏗️ Multi-tenant SaaS back ends with **NestJS** and **PostgreSQL**.
- 📦 **Turborepo** monorepos sharing types and logic between web and mobile.
...
|---|---|---|
| [**Paca Finance**](https://github.com/MariaEduardaaf/paca) | Couple finance app: web, mobile and blog in one monorepo | Expo, React, Supabase, Turborepo |
| [**Osprano**](https://github.com/MariaEduardaaf/Osprano) | Finds local businesses with weak web presence and drafts the outreach with AI | Next.js, Convex, Clerk |
| [**aifood**](https://github.com/MariaEduardaaf/aifood) | AI-assisted ordering and menu app | Next.js, Prisma |
